...
export class TokenCounter {
   ...
   */
  static countTextTokens(text: string, modelFamily: "openai" | "claude" | "gemini" = "openai"): number {
    if (!text) return 0;
   ...
   */
  static countContentTokens(content: LLMMessageContent, modelFamily: "openai" | "claude" | "gemini" = "openai"): number {
   ...
   */
  static countTurnTokens(turn: SessionTurn, modelFamily: "openai" | "claude" | "gemini" = "openai"): number {
